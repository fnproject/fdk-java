...
cd /tmp/cache-deps && mvn -s /tmp/cache-deps/local-settings.xml test package dependency:copy-dependencies -Dmdep.prependGroupId=true -DoutputDirectory=target $REPO_DFN
