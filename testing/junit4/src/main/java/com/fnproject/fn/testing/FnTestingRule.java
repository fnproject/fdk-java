...
public final class FnTestingRule implements TestRule {
   ...
   */
  public FnEventBuilder<FnTestingRule> givenEvent() {
   ...
   */
  private class DefaultFnEventBuilder implements FnEventBuilder<FnTestingRule>{
    ...
    @Override
    public FnEventBuilder<FnTestingRule> withHeader(String key, String value) {
      builder.withHeader(key, value);
      return this;
    }

    @Override
    public FnEventBuilder<FnTestingRule> withBody(InputStream body, int contentLength) {
      builder.withBody(body, contentLength);
      return this;
    }

    @Override
    public FnEventBuilder<FnTestingRule> withBody(byte[] body) {
      builder.withBody(body);
      return this;
    }

    @Override
    public FnEventBuilder<FnTestingRule> withBody(String body) {
      builder.withBody(body);
      return this;
    }

    @Override
    public FnEventBuilder<FnTestingRule> withAppName(String appName) {
      builder.withAppName(appName);
      return this;
    }

    @Override
    public FnEventBuilder<FnTestingRule> withRoute(String route) {
      builder.withRoute(route);
      return this;
    }

    @Override
    public FnEventBuilder<FnTestingRule> withMethod(String method) {
      builder.withMethod(method);
      return this;
    }

    @Override
    public FnEventBuilder<FnTestingRule> withRequestUrl(String requestUrl) {
    ...
    @Override
    public FnEventBuilder<FnTestingRule> withQueryParameter(String key, String value) {
